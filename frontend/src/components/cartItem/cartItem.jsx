    ...
    return(
        <div className='Item'>
            ...
            <div className='right-sidebar'>
                ...
                <p className="info author">by {props.author}</p>
                <p className="info isbn">ISBN: {props.isbn}</p>
                <p className="info genre">Genre: {props.genre}</p>
                <p className="info category">Category: {props.category}</p>
                <p className="info price">Price: {props.price * props.quantity}</p>
                ...
                <div className="change-quantity">
                    ...
                    <p className="info quantity">{props.quantity} copies in cart</p>
